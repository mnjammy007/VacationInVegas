...
@Model
class Place{
//    below is one more way to make things unique, and in this case,@Attribute(.unique) is not required
...
//        The data in this model is only stored in current running memory, not in actual database, since we're using for preview only
